...
- SDFs are downloaded in advertiser batches and active scope is based on IO status plus an active IO budget segment covering the run date, then LI status/effective dates

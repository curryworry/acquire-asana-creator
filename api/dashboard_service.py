...
SELECT
  ...
  SAFE_DIVIDE(GREATEST(booked_nett_cost - actual_cost, 0), remaining_days) AS required_daily_spend,
        ...
        data.append(
            {
                ...
                "REQUIRED_DAILY_SPEND": float(r["required_daily_spend"] or 0),
                "CURRENT_DAILY_SPEND": float(r["current_daily_cost"] or 0),
